...
public class LoginController {
    ...
    @ErrorLogAction(value = ActionType.ACCOUNT_REISSUE_TOKEN, actionDomain = DomainType.LOGIN)
    @AccessLevel(Level.PUBLIC)
    ...
    @ErrorLogAction(value = ActionType.ACCOUNT_LOGOUT, actionDomain = DomainType.LOGIN)
