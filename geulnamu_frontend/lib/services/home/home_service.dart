  ...
  void _processMenuAction(BuildContext context, String menuTitle) {
    switch (menuTitle) {
      ...
      case '글나무 소개':
        ...
        break;
      case '모임원 목록':
        context.push('/member-list');
        break;
      case '오늘의 모임':
        context.push('/meeting-list?filter=today');
        break;
      case '모임 목록':
        context.push('/meeting-list');
        break;
      case '모임 목록 (운영진용)':
        context.push('/meeting-list-staff');
        break;
      case '출석 체크':
        context.push('/qr-scanner');
        break;
      case '발제문 목록':
        context.push('/presentation-list');
        break;
      case '문의 목록':
        context.push('/voc-management');
        break;
      case '문의하기':
        context.push('/contact');
        break;
      case '푸시 알림':
        context.push('/push-notification');
        break;
      case '앱 정보':
