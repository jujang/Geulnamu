...
public class LoginController {
    ...
    @LogAction(value = ActionType.ACCOUNT_LOGIN, actionDomain = "login")
    ...
    @ErrorLogAction(value = ActionType.ACCOUNT_REISSUE_TOKEN, actionDomain = "login")
    @AccessLevel(Level.PUBLIC)
    ...
    @ErrorLogAction(value = ActionType.ACCOUNT_LOGOUT, actionDomain = "login")
