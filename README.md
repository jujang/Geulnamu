...
- **버그 신고**: [GitHub Issues](https://github.com/jujang/Geulnamu/issues) - 시스템 오류나 예상과 다른 동작
- **기능 요청**: [GitHub Issues](https://github.com/jujang/Geulnamu/issues) - 새로운 API 기능이나 개선 사항 제안
